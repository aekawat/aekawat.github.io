let githubUser = 'aekawat'
let repo = 'aekawat.github.io'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbzECmUyYklcz7qwAtMcpooxJ3rHyqiJ6TgthU91Thufj7kyxf1DIaG2uVyOOP-UuLy3/exec');
...
async function loadAlbum(username, albumName) {
    const response = await fetch(`https://api.github.com/repos/${githubUser}/${repo}/contents/${images}/${albumName}`);
